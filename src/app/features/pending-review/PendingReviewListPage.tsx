                ...
                {group.items.map((review) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        className="text-white text-sm h-8 w-20 rounded-lg flex items-center justify-center shrink-0"
                        style={{
                          backgroundColor:
                            review.status === "差し戻し"
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center gap-2 h-28 rounded-lg ${
                      selected ? "bg-white border border-[var(--semantic-brand-primary)]" : "bg-white"
                    }`}
                  >
