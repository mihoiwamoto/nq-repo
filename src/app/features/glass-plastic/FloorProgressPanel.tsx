import { FLOOR_STATUS_LABELS } from "./mockData";
import iconArrowRight from "../../../assets/figma/icons/common/arrow-right.svg";

export function FloorProgressPanel({
  floors,
  inspectedFloors,
  onClose
}: {
  ...
  const inspectedCount = inspectedFloors.length;
      ...
      <div className="relative flex h-full">
        ...
        <div className="bg-[var(--semantic-background-page)] shadow-[0px_2px_3px_rgba(51,51,51,0.24)] rounded-lg h-full w-[348px] px-6 py-4 flex flex-col gap-4 overflow-y-auto overflow-x-hidden">
          ...
          <div className="flex flex-col items-center w-full">
            {inspectedFloors.map((floor, index) => (
              <div key={floor.id} className="flex flex-col items-center w-full">
                <div className="bg-white flex flex-col gap-1 items-start justify-center px-2 py-4 rounded-lg w-full">
                  ...
                  <div className="flex items-start justify-between w-full">
                    ...
                    <p className="text-sm text-[var(--semantic-text-secondary)]">
                      {floor.inspectionDate ?? ""}
                    </p>
                  </div>
                </div>
                {index < inspectedFloors.length - 1 && (
