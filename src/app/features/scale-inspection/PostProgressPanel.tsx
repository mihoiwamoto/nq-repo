import { POST_STATUS_LABELS } from "./mockData";
import iconArrowRight from "../../../assets/figma/icons/common/arrow-right.svg";

export function PostProgressPanel({
  posts,
  inspectedPosts,
  onClose
}: {
  ...
  const inspectedCount = inspectedPosts.length;
