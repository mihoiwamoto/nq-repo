          ...
          <div className="px-4 py-6">
            <div className="flex items-center justify-between pb-6 border-b border-[#d0d0d0]">
              ...
              <div className="text-right">
                ...
                <p className="text-sm text-[#999999]">{selectedItem.inspector}, {formatDate(record.date)} {formatTime(selectedItem.timestamp)}</p>
              </div>
            </div>
          </div>
          ...
          <div className="px-4 py-6 border-b border-[#d0d0d0]">
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="text-right flex-shrink-0">
                ...
                <p className="text-sm text-[#999999] mt-1">{selectedItem.inspector}, {formatDate(record.date)} {formatTime(selectedItem.timestamp)}</p>
              </div>
            </div>
