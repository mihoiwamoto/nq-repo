...
export function WeightCheckerDeleteCompletePage() {
      ...
      <div className="flex flex-col gap-10 items-center justify-center p-6 pt-16">
        <div className="flex flex-col gap-6 items-center w-full">
          ...
          <p className="text-2xl text-[var(--semantic-text-primary)]">
            ウェイトチェッカー管理の削除が完了しました
          </p>
        </div>
        <Link
          to={`/admin/ledger-management/metal-xray-detection/factories/${factoryId}/weight-checkers`}
