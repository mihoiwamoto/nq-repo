...
import { sensoryConfirmationRecords } from "./mockData";
import type { ConfirmStatus, SensoryConfirmationRecord } from "./types";

type RecordsContextValue = {
  records: SensoryConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<SensoryConfirmationRecord[]>(sensoryConfirmationRecords);
