...
import type { Criterion, CriterionScore, SensoryConfirmationRecord } from "./types";
...
export const sensoryConfirmationRecords: SensoryConfirmationRecord[] = [
  {
    id: "snc1",
    date: "2025-04-01",
    ...
    scoreEntries: [
      {
        ...
        scores: {
          ...
          とろみ: {
            score: 2,
            reason: "成形温度の偏り",
            action: "成形機の温度設定を修正し、再検査で基準値内を確認",
