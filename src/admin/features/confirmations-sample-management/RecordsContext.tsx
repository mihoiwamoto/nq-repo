...
import { sampleConfirmationRecords } from "./mockData";
import type { ConfirmStatus, SampleConfirmationRecord } from "./types";

type RecordsContextValue = {
  records: SampleConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<SampleConfirmationRecord[]>(sampleConfirmationRecords);
