    ...
    <div>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "データ一覧", to: `/admin/confirmations/sample-management/factories/${factoryId}` },
          { label: "詳細" },
        ]}
      />
        ...
        <div className="bg-white flex flex-col gap-3 items-start px-4 py-6 rounded-lg w-full">
          ...
          {record.remarks && (
            <div className="flex flex-col gap-2 items-start w-full">
              ...
              <p className="text-base text-[var(--semantic-text-primary)] font-normal text-left">{record.remarks}</p>
            </div>
          )}
        </div>
