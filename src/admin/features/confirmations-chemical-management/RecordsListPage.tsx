...
export function RecordsListPage() {
  ...
  const basePath = `/admin/confirmations/chemical-management/factories/${factoryId}`;
    ...
    <div>
      ...
      <Breadcrumb
        items={[
          ...
          { label: "工場選択", to: "/admin/confirmations/chemical-management" },
          { label: "データ一覧" },
        ]}
      />
          ...
          {filterOpen && (
            <div className="flex flex-wrap gap-4 items-center justify-end w-full">
              <div className="flex flex-wrap gap-4 items-center flex-1 min-w-0">
                ...
                />
                <DateFilterInput value={dateFilter} onChange={setDateFilter} className="w-[160px]" />
                <Pulldown
