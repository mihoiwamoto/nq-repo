...
import { chemicalConfirmationRecords } from "./mockData";
import type { ChemicalConfirmationRecord, ConfirmStatus } from "./types";

type RecordsContextValue = {
  records: ChemicalConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<ChemicalConfirmationRecord[]>(chemicalConfirmationRecords);
