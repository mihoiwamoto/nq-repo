...
import { waterConfirmationRecords } from "./mockData";
import type { ConfirmStatus, WaterConfirmationRecord } from "./types";

type RecordsContextValue = {
  records: WaterConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<WaterConfirmationRecord[]>(waterConfirmationRecords);
