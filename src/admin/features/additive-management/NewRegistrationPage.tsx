...
export function NewRegistrationPage() {
  ...
  const existing = additives.find((item) => item.id === additiveId);
  ...
  function handleSubmit() {
    ...
    if (isEditing && existing) {
      ...
      navigate(`${basePath}/additives/registered`);
    }
  }
    ...
    <div>
      ...
      <div className="flex flex-col gap-10 items-start p-6">
        ...
        <div className="flex gap-4 items-center">
          <button
            type="button"
            onClick={() => navigate(isEditing ? `${basePath}/additives/${additiveId}` : basePath)}
