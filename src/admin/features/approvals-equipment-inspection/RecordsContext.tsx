...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<EquipmentApprovalRecord[]>(equipmentApprovalRecords);
