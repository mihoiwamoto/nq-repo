...
import { glassPlasticConfirmationRecords } from "./mockData";
import type { ConfirmStatus, GlassPlasticConfirmationRecord } from "./types";

type RecordsContextValue = {
  records: GlassPlasticConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<GlassPlasticConfirmationRecord[]>(glassPlasticConfirmationRecords);
