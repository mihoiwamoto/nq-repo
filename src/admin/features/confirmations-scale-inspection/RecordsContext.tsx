...
import { scaleConfirmationRecords } from "./mockData";
import type { ConfirmStatus, ScaleConfirmationRecord } from "./types";

type RecordsContextValue = {
  records: ScaleConfirmationRecord[];
...
export function RecordsProvider({ children }: { children: ReactNode }) {
  const [records, setRecords] = useState<ScaleConfirmationRecord[]>(scaleConfirmationRecords);
